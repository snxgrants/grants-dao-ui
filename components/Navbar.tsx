...
import {accountSelect, connect, disconnect, getTruncatedAddress, isConnected} from "../services/Wallet"
...
import {
    ...
    UpperCased,
    white,
    FlexDivColCentered, FlexDivCol, condensedMedium
} from "../styles/common";
...
export const Navbar = () => {
    ...
    if (isConnected()) {
        walletRender = <>
            <WalletButton variant="solid" onClick={() => setWalletOptionsModalOpened(!walletOptionsModalOpened)}>
                <FlexDivCentered>
                    <StyledConnectionDot/>
                    <UpperCased>{getTruncatedAddress()}</UpperCased>
                </FlexDivCentered>
            </WalletButton>
