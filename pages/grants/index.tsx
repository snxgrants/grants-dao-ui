							...
							<div className="col-md-12">
								<div className="hero-content grants-vh">
									...
									<p className="wow fadeInUp synth-p-opti align-center" data-wow-delay=".6s">
										Synthetix GrantsDAO is a decentrailzed organisation part of the Synthetix
										protocol that governs the process of funding projects that contribute to the
										adoption of Synthetix.
									</p>
								</div>
							</div>
						</div>
						...
						>
							<div className="container">
								<div className="heading-wrapper">
									<div className="row">
										<div className="col-md-6 col-sm-12 active-tab-header">GRANTS - ALL</div>
