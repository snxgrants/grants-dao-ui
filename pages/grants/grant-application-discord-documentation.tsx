...
export default function GrantApplicationDiscordDocumentation() {
    return (
        <>
            <Head>
                <title>Discord Documentation | Synthetix grantsDAO</title>
            </Head>
            ...
            <main>
                        ...
                        <div className="row align-items-center position-relative">
                            <div className="col-md-12">
                                <div className="hero-content grants-individual-vh">
                                    ...
                                    <h4 className="wow fadeInUp grants-indi-description align-center" data-wow-delay=".6s" style={{color: '#00D1FF'}}>Discord Documentation</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grant-indi-bg">
                        ...
                        <div className="row grants-pager-wrapper">
                            <div className="col-md-12">
                                <ul className="pager">
                                    ...
                                    <li className="next">
                                        <a className="grants-pager-link" href="grant-application-coinbase-hedging-bot.html">NEXT GRANT <span className="synth-up-arrow"><img alt="Arrow" className="pager-icons" src="/img/grants/gdao-next.svg" /></span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="synth-tabs">
                                            <span className="sm-font no-margin bio-info"><span className="bio-info">Requested by</span> <span className="bio-info synth-blue">Bigs</span> in <span className="sm-font bio-info synth-pink">Grants</span> <span className="sm-font bio-info">on <span className="synth-blue">9 April 2021</span></span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    {/* ========================= Blue Banner End ========================= */}{/* ========================= grantsDAO Info Summary Start ========================= */}
                                        ...
                                        <div className="indi-btn-wrapper">
                                            <div className="utility-btn">
                                                <div className="voting-wrapper">
                                                    <div className="vertical-align grants-approved wow fadeInUp animated" data-wow-delay=".3s">
                                                        APPROVED
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="utility-btn">
                                                <a href="#"><button className="vertical-align grants-cancel wow fadeInUp animated" data-wow-delay=".3s" style={{visibility: 'visible', animationDelay: '0.6s', animationName: 'fadeInUp'}}>CANCEL GRANT</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="row">
                                            ...
                                            <div className="col-md-4 synth-tabs">
                                                <span className="candidates-h">NO VOTES</span><span className="votes-amount">1</span>
                                            </div>
                                            <div className="col-md-1">
                                            </div>
                    ...
                    <section className="candidates-info anchor" id="candidates-info">
                        {/* ========================= Tab Data Headings========================= */}
                        <div className="container">
                            <div className="heading-wrapper max-width">
                                <div className="row">
                                ...
                                <div className="voter-wrapper">
                                    <div className="row">
                                        ...
                                        <div className="align-center col-md-3 col-sm-12 vertical-align">
                                            <div className="utility-btn">
                                                <div className="voting-wrapper">
                                                    <div className="vertical-align grants-no">
                                                        NO
                                                    </div>
                                                </div>
                                            </div>
