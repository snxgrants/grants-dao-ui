...
export default function GdaiSiteDesignAndBuildInitiative() {
    return (
        <>
            <Head>
                <title>gDAO Site Design Competition | Synthetix Initiatives</title>
            </Head>
                        ...
                        <div className="row align-items-center position-relative">
                            <div className="col-md-12">
                                <div className="hero-content grants-individual-vh">
                                    ...
                                    <h4 className="wow fadeInUp grants-indi-description align-center" data-wow-delay=".6s" style={{color: '#00D1FF'}}>gDAO Site Design Competition</h4>
                                </div>
                            </div>
                        </div>
                    </div>
