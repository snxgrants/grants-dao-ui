...
export default function GrantApplicationThankYou() {
    return (
        <>
            <Head>
                <title>STSLA Meme Site Design Competition | Synthetix Initiatives</title>
            </Head>
                        ...
                        <div className="row align-items-center position-relative">
                            <div className="col-md-12">
                                <div className="hero-content grants-individual-vh">
                                    ...
                                    <h4 className="wow fadeInUp grants-indi-description align-center" data-wow-delay=".6s" style={{color: '#00D1FF'}}>sTSLA Meme Site Design Comp v1</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row grants-pager-wrapper">
                            <div className="col-md-12">
                                <ul className="pager">
                                    ...
                                    <li className="next">
                                        <a className="grants-pager-link" href="chainlink-hackathon-initiative.html">NEXT INITIATIVE <span className="synth-up-arrow"><img alt="Arrow" className="pager-icons" src="/img/grants/gdao-next.svg" /></span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
