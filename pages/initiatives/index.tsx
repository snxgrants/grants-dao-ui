                                    ...
                                    <div className="row">
                                        <div className="col-md-6 col-sm-12 data-p">
                                            ...
                                            <div className="request-details-wrapper">
                                                <span className="sm-font no-margin bio-info"><span className="bio-info">Initiated by</span> <span className=" bio-info synth-blue">Andy</span> in <span className="sm-font bio-info synth-pink">Initiatives</span> <span className="sm-font bio-info">on <span className="synth-blue">20 April 2021</span></span></span>
                                            </div>
                                        </div>
                                        <div className="col-md-2" />
                                        <div className="vertical-align align-center col-md-2 col-sm-12">
                                ...
                                <div className="data-wrapper">
                                    <div className="row">
                                        <div className="col-md-6 col-sm-12 data-p">
                                            ...
                                            <div className="request-details-wrapper">
                                                <span className="request no-margin bio-info"><span className="bio-info">initiated by</span> <span className=" bio-info synth-blue">ΔLΞXΔNDΞR</span> in <span className="bio-info synth-pink">Initiatives</span> <span className="sm-font bio-info">on <span className="synth-blue">9 April 2021</span></span></span>
                                            </div>
                                        </div>
                                        <div className="col-md-2" />
                                        <div className="vertical-align align-center col-md-2 col-sm-12">
                                ...
                                <div className="data-wrapper">
                                    <div className="row">
                                        <div className="col-md-6 col-sm-12 data-p">
                                            ...
                                            <div className="request-details-wrapper">
                                                <span className="request no-margin bio-info"><span className="bio-info">initiated by</span> <span className=" bio-info synth-blue">cryptotoit</span> in <span className="bio-info synth-pink">Initiatives</span> <span className="sm-font bio-info">on <span className="synth-blue">17 April 2021</span></span></span>
                                            </div>
                                        </div>
                                        <div className="col-md-2" />
                                        <div className="vertical-align align-center col-md-2 col-sm-12">
                                ...
                                <div className="data-wrapper">
                                    <div className="row">
                                        <div className="col-md-6 col-sm-12 data-p">
                                            ...
                                            <div className="request-details-wrapper">
                                                <span className="request no-margin bio-info"><span className="bio-info">initiated by</span> <span className=" bio-info synth-blue">RubberˆDuck</span> in <span className="bio-info synth-pink">Initiatives</span> <span className="sm-font bio-info">on <span className="synth-blue">23 April 2021</span></span></span>
                                            </div>
                                        </div>
                                        <div className="col-md-2" />
                                        <div className="vertical-align align-center col-md-2 col-sm-12">
