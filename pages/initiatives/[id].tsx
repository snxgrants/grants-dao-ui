  ...
  return (
    <>
      ...
      <main>
        ...
        <section
          className="synth-grants-initiatives-individual-section"
          id="inititatives-indi"
        >
            ...
            <div className="container">
              <div className="row grants-descr-wrapper padding-bottom">
                ...
                <p className="gdao-descriptor">
                  ...
                  typesetting, remaining essentially unchanged. Dynamic data for
                  this section from overview content submitted.
                </p>
                ...
                <p className="gdao-descriptor">
                  ...
                  not only five centuries, but also the leap into electronic
                  typesetting, remaining essentially unchanged. Dynamic data for
                  this section from VALUE TO Synthetix content submitted.
                </p>
                ...
                <p className="gdao-descriptor">
                  ...
                  not only five centuries, but also the leap into electronic
                  typesetting, remaining essentially unchanged. Dynamic data for
                  this section from implementation plan content submitted.
                </p>
                <div className="h4-grants-dao-descr">
                ...
                <p className="gdao-descriptor">
                  ...
                  not only five centuries, but also the leap into electronic
                  typesetting, remaining essentially unchanged. Dynamic data for
                  this section from value to SynthetixX additional information
                  contentnsubmitted.
                </p>
                <div className="h4-grants-dao-descr">BUDGET BREAKDOWN</div>
                <p className="gdao-descriptor">
                  since the 1500s, when an unknown printer took a galley of type
                  and scrambled it to make a type specimen book. It has survived
                  not only five centuries, but also the leap into electronic
                  typesetting, remaining essentially unchanged. Dynamic data for
                  this section budget breakdown content submitted.
                </p>
              </div>
            </div>
          </section>
                ...
                <div className="row">
                  ...
                  <div className="vertical-align align-center col-md-3 col-sm-12">
                    <div className="indi-amount-wrapper">
                      <div className="grants-indi-amount">1500 SNX</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-md-9">
                    <div className="row">
                      <div className="col-md-12">
                        <div className="row">
                          <div className="info-left col-md-2">Initiated by</div>
                          <div className="info-right col-md-2">Andy</div>
                        ...
                        <div className="row">
                          ...
                          <div className="info-left col-md-3">End Date</div>
                          <div className="info-right col-md-4">
                            April 30, 2022, 2:00 AM
                          </div>
                        </div>
                        <div className="row">
                          <div className="info-left col-md-2">Voting</div>
                          <div className="info-right col-md-2">Internal</div>
                          <div className="info-left col-md-3">
                            Optional info
                          </div>
                          <div className="info-right col-md-4">
