...
export default function Initiatives() {
    return (
        <>
            <Head>
                <title>Ambassador Delegation Site v1 | Synthetix Initiatives</title>
            </Head>
            ...
            <main>
                            ...
                            <div className="col-md-12">
                                <div className="hero-content grants-individual-vh">
                                    <div className="synth-gdao-grants-mini-logo">
                                        <img className="gdao-mini-logo" src="/img/logo/synthetix_gdao_logo_mini.svg" alt="Logo" />
                                    </div>
                ...
                <span className="synth-up-arrow">
                  <img alt="Arrow" className="pager-icons" src="/img/grants/gdao-previous.svg" />
                                    ...
                                    <li className="next">
                                        <a className="grants-pager-link" href="debt-hedging-zaps-initiative.html">
                                            NEXT INITIATIVE
                                            <span className="synth-up-arrow">
