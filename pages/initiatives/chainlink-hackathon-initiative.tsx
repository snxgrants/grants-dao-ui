...
export default function ChainLinkHackathonInitiative() {
    return (
        <>
            <Head>
                <title>Chainlink Hackathon | Synthetix Initiatives</title>
            </Head>
                        ...
                        <div className="row align-items-center position-relative">
                            <div className="col-md-12">
                                <div className="hero-content grants-individual-vh">
                                    ...
                                    <h4 className="wow fadeInUp grants-indi-description align-center" data-wow-delay=".6s" style={{color: '#00D1FF'}}>Chainlink Hackathon</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row grants-pager-wrapper">
                            <div className="col-md-12">
                                <ul className="pager">
                                    ...
                                    <li className="next">
                                        <a className="grants-pager-link" href="gdao-site-design-competition-initiative.html">NEXT INITIATIVE <span className="synth-up-arrow"><img alt="Arrow" className="pager-icons" src="/img/grants/gdao-next.svg" /></span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="row grants-pager-wrapper">
                            <div className="col-md-12">
                                <ul className="pager">
                                    ...
                                    <li className="next">
                                        <a className="grants-pager-link" href="gdao-site-design-and-build-initiative.html">NEXT INITIATIVE <span className="synth-up-arrow"><img alt="Arrow" className="pager-icons" src="/img/grants/gdao-next.svg" /></span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
