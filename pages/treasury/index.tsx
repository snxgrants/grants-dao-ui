            ...
            <main>
                ...
                <div className="treasury-bg">
                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div className="synth-tabs">
                                                <div className="align-center current-balance-h">CURRENT BALANCE</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="row">
                            <div className="col-md-12 max-width">
                                <div className="row">
                                    ...
                                    <div className="col-md-3">
                                        <div className="vertical-align treasury-susd">
                                            xxx sUSD
                                        </div>
                                    </div>
                                    <div className="col-md-3">
                                        <div className="vertical-align treasury-eth">
                                            xxx ETH
                                        </div>
                                    </div>
                                    <div className="col-md-3">
                                        <div className="vertical-align treasury-seth">
                                            xxx sETH
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="col-md-10">
                                        <div className="synth-tabs">
                                            <ul className="tabs nav nav-tabs" id="myTab" role="tablist">
                                                ...
                                                <li className="nav-item" role="presentation">
                                                    <button aria-controls="completed" aria-selected="false" className="nav-link" data-bs-target="#completed" data-bs-toggle="tab" id="completed-tab" role="tab" type="button">Grants</button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button aria-controls="cancelled" aria-selected="false" className="nav-link" data-bs-target="#initiatives" data-bs-toggle="tab" id="cancelled-tab" role="tab" type="button">Initiatives</button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button aria-controls="cancelled" aria-selected="false" className="nav-link" data-bs-target="#competitions" data-bs-toggle="tab" id="competitions-tab" role="tab" type="button">Competitions</button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button aria-controls="other" aria-selected="false" className="nav-link" data-bs-target="#other" data-bs-toggle="tab" id="other-tab" role="tab" type="button">Other</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                  ...
                  <span className="request no-margin bio-info">
                    ...
                    <span className="bio-info synth-blue"> xxxxxxxxxxx</span>
                  </span>
                                            </div>
                                        </div>
                                        <div className="vertical-align align-center col-md-1 col-sm-12">
                                        </div>
                                ...
                                <div className="data-wrapper">
                                    <div className="row">
                                        <div className="col-md-6 col-sm-12 data-p">
                                            ...
                                            <div className="request-details-wrapper">
                                                <span className="request no-margin bio-info"><span className="bio-info">Initiated by</span> <span className=" bio-info synth-blue">ΔLΞXΔNDΞR</span> in <span className="bio-info synth-pink">Initiatives</span> <span className="sm-font bio-info">on <span className="synth-blue">23 April 2021</span></span></span>
                                            </div>
                                            <div className="request-details-wrapper">
                  <span className="request no-margin bio-info">
                    <span className="bio-info">Transaction ID</span>
                  ...
                  <span className="request no-margin bio-info">
                    ...
                    <span className="bio-info synth-blue"> xxxxxxxxxxx</span>
                        ...
                        {/* Grants End*/}
                        {/* Initiatives Start*/}
                        <div aria-labelledby="initiatives-tab" className="tab-pane fade" id="initiatives" role="tabpanel">
                            <div className="container">
                                <div className="heading-wrapper">
                                    <div className="row">
                                        <div className="col-md-6 col-sm-12 active-tab-header">
                  ...
                  <span className="request no-margin bio-info">
                    ...
                    <span className="bio-info synth-blue"> xxxxxxxxxxx</span>
                        ...
                        {/* Initiatives End*/}
                        {/* Competitions start*/}
                        <div aria-labelledby="competitions-tab" className="tab-pane fade" id="competitions" role="tabpanel">
                            <div className="container">
                                <div className="heading-wrapper">
                                    <div className="row">
                                        <div className="col-md-6 col-sm-12 active-tab-header">
                  ...
                  <span className="request no-margin bio-info">
                    ...
                    <span className="bio-info synth-blue"> xxxxxxxxxxx</span>
                        ...
                        {/* Competitions End*/}
                        {/* Other Start*/}
                        <div aria-labelledby="other-tab" className="tab-pane fade" id="other" role="tabpanel">
                            <div className="container">
                                <div className="heading-wrapper">
                                    <div className="row">
                                        <div className="col-md-6 col-sm-12 active-tab-header">
                                ...
                                <div className="data-wrapper">
                                    <div className="row">
                                        <div className="col-md-6 col-sm-12 data-p">
                                            ...
                                            <div className="request-details-wrapper">
                                                <span className="request no-margin bio-info"><span className="bio-info">Initiated by</span> <span className=" bio-info synth-blue">ΔLΞXΔNDΞR</span> in <span className="bio-info synth-pink">xxx</span> <span className="sm-font bio-info">on <span className="synth-blue">23 April 2021</span></span></span>
                                            </div>
                                            <div className="request-details-wrapper">
                  <span className="request no-margin bio-info">
                    <span className="bio-info">Transaction ID</span>
