          ...
          <section className="grants-introduction">
            <div className="container">
              <div className="row grants-descr-wrapper padding-bottom">
                ...
                <p className="gdao-descriptor">{competitionValue.overview}</p>
                ...
                <p className="gdao-descriptor">{competitionValue.background}</p>
                ...
                <div className="voter-wrapper">
                  <div className="row">
                    ...
                    <div className="align-center col-md-3 col-sm-12 vertical-align">
                      <div className="utility-btn">
                        <div>
                          <div className="vertical-align grants-yes">YES</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="col-md-1">
                      <img
                        alt="Avatar"
                        className="member-avatar"
                        src="/img/grants/member-avatar.png"
                      />
                    </div>
                    <div className="col-md-5 col-sm-12 vertical-align">
                      <a href="#">
