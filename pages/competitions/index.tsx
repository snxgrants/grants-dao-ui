...
export default function Competitions() {
    ...
    let completitionsRender = [] ;

    Object.entries(competitionsData).forEach(([key, completition]) => completitionsRender.push (
                    ...
                    <div className="col-md-6 col-sm-12 data-p">
                        <div className="data-description-wrapper">
                            <Link href={'/competitions/'+key}>
                                <a className="hover" >
                                    <h4 className="no-margin grantsdao-data-heading padding-right">{completition.title}</h4>
